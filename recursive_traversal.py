...
g = depth(nested_list)
print("max depth of nested lists: ", g)
...
"""SORRY this is my first time using github im still tryna figure out how to submit things easily im sorry if any of my submissions or anythings is in a weird way and stuff"""
